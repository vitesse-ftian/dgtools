 ...
 * @author VitesseData
 */
public class LoadTableNodePlugin extends Plugin {
    // The shared instance.
    private static LoadTableNodePlugin plugin;

    /**
     * The constructor.
     */
    public LoadTableNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static LoadTableNodePlugin getDefault() {
        return plugin;
    }
