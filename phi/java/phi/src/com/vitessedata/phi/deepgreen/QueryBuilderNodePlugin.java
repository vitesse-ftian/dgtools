 ...
 * @author VitesseData
 */
public class QueryBuilderNodePlugin extends Plugin {
    // The shared instance.
    private static QueryBuilderNodePlugin plugin;

    /**
     * The constructor.
     */
    public QueryBuilderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static QueryBuilderNodePlugin getDefault() {
        return plugin;
    }
