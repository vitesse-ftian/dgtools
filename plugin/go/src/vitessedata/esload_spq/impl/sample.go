...
func DoSample(req xdrive.SampleRequest, es_url, indexname string, nshards int, aws_access_id, aws_access_key string) error {
	var err error
	var es ESClient
...
*/
	...
	var reader ESReader
	reader.Init(req.Filespec, req.Columndesc, nil)

	_, _, err = reader.process(body, default_size)
	if err != nil {
